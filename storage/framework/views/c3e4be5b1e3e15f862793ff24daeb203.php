...
<link rel="shortcut icon" href="<?php echo e(asset('web/images/Online_Saptari_Logo.jpeg')); ?>">
        ...
        <div class="utf_left_side">
          <div id="logo">
            <a href="<?php echo e(route('home')); ?>">
              <img src="<?php echo e(asset('web/images/Online_Saptari_Logo.jpeg')); ?>" alt="Online Saptari">
            </a>
          </div>
          ...
          <div class="utf_signin_form style_one">
            ...
            <div class="tab_container alt">
              ...
              <div class="tab_content" id="tab1">
                <form method="POST" action="<?php echo e(route('login.submit')); ?>" class="login">
                  <?php echo csrf_field(); ?>
                  <p class="utf_row_form utf_form_wide_block">
                    <input type="email" class="input-text" name="email" placeholder="Email" required autofocus value="<?php echo e(old('email')); ?>">
                  </p>
                  <p class="utf_row_form utf_form_wide_block">
                  ...
                  <div class="utf_row_form utf_form_wide_block form_forgot_part">
                    <span class="lost_password fl_left"><a href="<?php echo e(route('password.request')); ?>">Forgot Password?</a></span>
...
<?php /**PATH C:\xampp\htdocs\Online_Saptari\resources\views/web/layouts/header.blade.php ENDPATH**/ ?>