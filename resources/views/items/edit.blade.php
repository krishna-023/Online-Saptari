                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="v-pills-Category" role="tabpanel"
                                                ...
                                                <div>
                                                    <div class="row g-3">
                                                        <div class="col-sm-6">
                                                            <input type="radio" name="category" value="select_category"
                                                                onclick="showCategorList()"
                                                                {{ old('category') == 'select_category' ? 'checked' : '' }}>
                                                            Select From Category List
                                                            <input type="radio" name="category" value="new_category"
                                                                onclick="showCategoryTextBox()"
                                                                {{ old('category') == 'new_category' ? 'checked' : '' }}>
                                                            Create New

                                                            <select id="category_id_select" name="category_id"
                                                                class="form-select">
                                                                <option value="">All Categories</option>
                                                                @foreach ($categories as $optionCategory)
                                                                    <option value="{{ $optionCategory->id }}"
                                                                        {{ $item->category_id == $optionCategory->id ? 'selected' : '' }}>
                                                                        {{ $optionCategory->Category_Name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                            <input type="text" name="category_name"
                                                                id="category_id_new" class="d-none">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="reference_id" class="form-label">Item ID:</label>
                                                        <input type="number"
                                                ...
                                                <div class="d-flex align-items-start gap-3 mt-4">
                                                    <button type="button"
                                                        ...
                                                        data-nexttab="v-pills-Main-tab"><i
                                                ...
                                                <div>
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <textarea class="form-control @error('content') is-invalid @enderror" id="content" name="content" rows="3">{{ old('content', $item->content) }}</textarea>
                                                            @error('content')
                                                                <span class="text-danger"
                                                                    role="alert"><strong>{{ $message }}</strong></span>
                                                            @enderror
                                                        ...
                                                        <div class="col-md-6">
                                                            <label for="item_featured" class="form-label">Item
                                                                Featured:</label>
                                                            <input type="text"
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="date"
                                                                ...
                                                                value="{{ old('collection_date', $item->collection_date) }}"
                                                                required>
                                                        ...
                                                        <div class="col-md-6">
                                                            <label for="author_username" class="form-label">Author
                                                                Username:</label>
                                                            <input type="text"
                                                        ...
                                                        <div class="col-md-6">
                                                            <label for="author_email" class="form-label">Author
                                                                Email:</label>
                                                            <input type="email"
                                                        ...
                                                        <div class="col-md-6">
                                                            <label for="parent_slug" class="form-label">Parent
                                                                Slug:</label>
                                                            <input type="text"
                                                    ...
                                                    <div class="row gy-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('telephone', $contacts->telephone ?? '') }}"
                                                                required>
                                                            @error('telephone')
                                                                <span class="text-danger"
                                                                    role="alert"><strong>{{ $message }}</strong></span>
                                                            @enderror
                                                            <small class="text-muted">Telephone number should be
                                                                valid</small>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div id="additional-phones">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    value="{{ old('phone1', $contacts->phone1 ?? '') }}">
                                                                @error('phone1')
                                                                    <span class="text-danger"
                                                                        role="alert"><strong>{{ $message }}</strong></span>
                                                                @enderror
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    value="{{ old('phone2', $contacts->phone2 ?? '') }}">
                                                                @error('phone2')
                                                                    <span class="text-danger"
                                                                        role="alert"><strong>{{ $message }}</strong></span>
                                                                @enderror
                                                            ...
                                                            <button type="button" class="btn btn-primary"
                                                                id="add-phone">Add More Phone Numbers</button>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <label for="contactOwnerBtn" class="form-label">Contact Owner
                                                                Button:</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <label for="webLinkLabel" class="form-label">Website Link
                                                                Label:</label>
                                                            <input type="text"
                                                                class="form-control @error('webLinkLabel') is-invalid @enderror"
                                                                id="webLinkLabel" name="webLinkLabel"
                                                                value="{{ old('webLinkLabel', $contacts->webLinkLabel ?? '') }}">
                                                            @error('webLinkLabel')
                                                                <span class="text-danger"
                                                                    role="alert"><strong>{{ $message }}</strong></span>
                                                            @enderror
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('latitude', $contacts->latitude ?? '') }}">
                                                            @error('latitude')
                                                                <span class="text-danger"
                                                                    role="alert"><strong>{{ $message }}</strong></span>
                                                            @enderror
                                                        ...
                                                        <div class="col-md-6">
                                                            <label for="streetview" class="form-label">Street
                                                                View:</label>
                                                            <input type="text"
                                                                class="form-control @error('streetview') is-invalid @enderror"
                                                                id="streetview" name="streetview"
                                                                value="{{ old('streetview', $contacts->streetview ?? '') }}">
                                                            @error('streetview')
                                                                <span class="text-danger"
                                                                    role="alert"><strong>{{ $message }}</strong></span>
                                                            @enderror
                                                        ...
                                                        <div class="col-md-6">
                                                            <label for="swheading" class="form-label">Street View
                                                                Heading:</label>
                                                            <input type="text"
                                                                class="form-control @error('swheading') is-invalid @enderror"
                                                                id="swheading" name="swheading"
                                                                value="{{ old('swheading', $contacts->swheading ?? '') }}">
                                                            @error('swheading')
                                                                <span class="text-danger"
                                                                    role="alert"><strong>{{ $message }}</strong></span>
                                                            @enderror
                                                        ...
                                                        <div class="col-md-6">
                                                            <label for="swpitch" class="form-label">Street View
                                                                Pitch:</label>
                                                            <input type="text"
                                                                class="form-control @error('swpitch') is-invalid @enderror"
                                                                id="swpitch" name="swpitch"
                                                                value="{{ old('swpitch', $contacts->swpitch ?? '') }}">
                                                            @error('swpitch')
                                                                <span class="text-danger"
                                                                    role="alert"><strong>{{ $message }}</strong></span>
                                                            @enderror
                                                        ...
                                                        <div class="col-md-6">
                                                            <label for="swzoom" class="form-label">Street View
                                                                Zoom:</label>
                                                            <input type="text"
                                                                class="form-control @error('swzoom') is-invalid @enderror"
                                                                id="swzoom" name="swzoom"
                                                                value="{{ old('swzoom', $contacts->swzoom ?? '') }}">
                                                            @error('swzoom')
                                                                <span class="text-danger"
                                                                    role="alert"><strong>{{ $message }}</strong></span>
                                                            @enderror
                                                ...
                                                <div class="d-flex align-items-start gap-3 mt-4">
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-nexttab="v-pills-openingtime-tab"><i
                                                            class="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i>Go
                                                        to Opening Hours</button>
                                                </div>
                                            </div>

                                            <!-- end tab pane -->
                                            <div class="tab-pane fade" id="v-pills-openingtime" role="tabpanel"
                                                aria-labelledby="v-pills-openingtime-tab">
                                                <div>
                                                    <h5>Opening Hours</h5>
                                                    <p class="text-muted">Fill all information below</p>
                                                </div>
                                                ...
                                                <div>
                                                    <div class="row gy-3">
                                                        <div class="col-md-6">
                                                            <label for="displayOpeningHours" class="form-label">Display
                                                                Opening Hours:</label>
                                                            <input type="checkbox" id="displayOpeningHours"
                                                                name="displayOpeningHours" value="1"
                                                                {{ old('displayOpeningHours', $opening_time->displayOpeningHours ?? false) ? 'checked' : '' }}>
                                                        </div>
                                                        <div class="col-gy-6">
                                                            <label for="openingHoursMonday">Opening Hours Monday:</label>
                                                            <input type="text"
                                                                class="form-control @error('openingHoursMonday') is-invalid @enderror"
                                                                id="openingHoursMonday" name="openingHoursMonday"
                                                                value="{{ old('openingHoursMonday', $opening_time->openingHoursMonday ?? '') }}">
                                                        ...
                                                        <div class="col-gy-3">
                                                            <label for="openingHoursTuesday" class="form-label">Opening
                                                                Hours Tuesday:</label>
                                                            <input type="text"
                                                                class="form-control @error('openingHoursTuesday') is-invalid @enderror"
                                                                id="openingHoursTuesday" name="openingHoursTuesday"
                                                                value="{{ old('openingHoursTuesday', $opening_time->openingHoursTuesday ?? '') }}">
                                                        ...
                                                        <div class="col-gy-3">
                                                            <label for="openingHoursWednesday" class="form-label">Opening
                                                                Hours Wednesday:</label>
                                                            <input type="text"
                                                                class="form-control @error('openingHoursWednesday') is-invalid @enderror"
                                                                id="openingHoursWednesday" name="openingHoursWednesday"
                                                                value="{{ old('openingHoursWednesday', $opening_time->openingHoursWednesday ?? '') }}">
                                                        ...
                                                        <div class="col-gy-3">
                                                            <label for="openingHoursThursday" class="form-label">Opening
                                                                Hours Thursday:</label>
                                                            <input type="text"
                                                                class="form-control @error('openingHoursThursday') is-invalid @enderror"
                                                                id="openingHoursThursday" name="openingHoursThursday"
                                                                value="{{ old('openingHoursThursday', $opening_time->openingHoursThursday ?? '') }}">
                                                        ...
                                                        <div class="col-gy-3">
                                                            <label for="openingHoursFriday" class="form-label">Opening
                                                                Hours Friday:</label>
                                                            <input type="text"
                                                                class="form-control @error('openingHoursFriday') is-invalid @enderror"
                                                                id="openingHoursFriday" name="openingHoursFriday"
                                                                value="{{ old('openingHoursFriday', $opening_time->openingHoursFriday ?? '') }}">
                                                        ...
                                                        <div class="col-gy-3">
                                                            <label for="openingHoursSaturday" class="form-label">Opening
                                                                Hours Saturday:</label>
                                                            <input type="text"
                                                                class="form-control @error('openingHoursSaturday') is-invalid @enderror"
                                                                id="openingHoursSaturday" name="openingHoursSaturday"
                                                                value="{{ old('openingHoursSaturday', $opening_time->openingHoursSaturday ?? '') }}">
                                                        ...
                                                        <div class="col-gy-3">
                                                            <label for="openingHoursSunday" class="form-label">Opening
                                                                Hours Sunday:</label>
                                                            <input type="text"
                                                                class="form-control @error('openingHoursSunday') is-invalid @enderror"
                                                                id="openingHoursSunday" name="openingHoursSunday"
                                                                value="{{ old('openingHoursSunday', $opening_time->openingHoursSunday ?? '') }}">
                                                        ...
                                                        <div class="col-gy-6">
                                                            ...
                                                            <textarea class="form-control @error('openingHoursNote') is-invalid @enderror" id="openingHoursNote"
                                                                name="openingHoursNote" rows="3">{{ old('openingHoursNote', $opening_time->openingHoursNote ?? '') }}</textarea>
                                                ...
                                                <div class="d-flex align-items-start gap-3 mt-4">
                                                    <button type="button" class="btn btn-light btn-label previestab"
                                                        data-previous="v-pills-contacts-tab"><i
                                                            class="ri-arrow-left-line label-icon align-middle fs-lg me-2"></i>
                                                        Back to Contact</button>
                                                    <button type="button"
                                                        class="btn btn-success btn-label right ms-auto nexttab nexttab"
                                                        data-nexttab="v-pills-socialicons-tab"><i
                                                            class="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i>Go
                                                        to SocialIcons</button>
                                                </div>
                                            </div>

                                            <!-- end tab pane -->
                                            <div class="tab-pane fade" id="v-pills-socialicons" role="tabpanel"
                                                aria-labelledby="v-pills-socialicons-tab">
                                                <div>
                                                    <h5>SocialIcons</h5>
                                                    <p class="text-muted">Fill all information below</p>
                                                </div>
                                                ...
                                                <div>
                                                    <div class="row gy-3">
                                                        <div class="col-md-6">
                                                            <label for="displaySocialIcons" class="form-label">Display
                                                                Social Icons:</label>
                                                            <input type="checkbox" name="displaySocialIcons"
                                                                value="1"
                                                                {{ old('displaySocialIcons', $socialIcon->displaySocialIcons ?? false) ? 'checked' : '' }}>
                                                        </div>

                                                        <div class="col-md-6">
                                                            <label for="socialIconsOpenInNewWindow">Open Social Icons in
                                                                New Window:</label>
                                                            <input type="checkbox" id="socialIconsOpenInNewWindow"
                                                                name="socialIconsOpenInNewWindow" value="1"
                                                                {{ old('socialIconsOpenInNewWindow', $socialIcon->socialIconsOpenInNewWindow ?? false) ? 'checked' : '' }}>
                                                        </div>

                                                        <div class="col-md-6">
                                                            <label for="socialIcons" class="form-label">Select Social
                                                                Icon:</label>
                                                            <select class="form-select" id="iconSelect"
                                                                name="socialIcons">
                                                                <option value="">Select an Icon</option>
                                                                <option value="facebook"
                                                                    {{ old('socialIcons', $socialIcon->socialIcons) == 'facebook' ? 'selected' : '' }}>
                                                                    Facebook</option>
                                                                <option value="twitter"
                                                                    {{ old('socialIcons', $socialIcon->socialIcons) == 'twitter' ? 'selected' : '' }}>
                                                                    Twitter</option>
                                                                <option value="linkedin"
                                                                    {{ old('socialIcons', $socialIcon->socialIcons) == 'linkedin' ? 'selected' : '' }}>
                                                                    LinkedIn</option>
                                                                <option value="instagram"
                                                                    {{ old('socialIcons', $socialIcon->socialIcons) == 'instagram' ? 'selected' : '' }}>
                                                                    Instagram</option>
                                                                <option value="youtube"
                                                                    {{ old('socialIcons', $socialIcon->socialIcons) == 'youtube' ? 'selected' : '' }}>
                                                                    YouTube</option>
                                                                <option value="github"
                                                                    {{ old('socialIcons', $socialIcon->socialIcons) == 'github' ? 'selected' : '' }}>
                                                                    GitHub</option>
                                                            </select>
                                                        </div>

                                                        <div class="col-md-6">
                                                            <label for="socialIcons_url" class="form-label">Social Icons
                                                                URL:</label>
                                                            <input type="text" name="socialIcons_url"
                                                                class="form-control @error('socialIcons_url') is-invalid @enderror"
                                                                value="{{ old('socialIcons_url', $socialIcon->socialIcons_url ?? '') }}">
                                                ...
                                                <div class="d-flex align-items-start gap-3 mt-4">
                                                    <button type="button" class="btn btn-light btn-label previestab"
                                                        data-previous="v-pills-openingtime-tab"><i
                                                            class="ri-arrow-left-line label-icon align-middle fs-lg me-2"></i>
                                                        Back to Opening Hours</button>
                                                    <button type="button"
                                                        class="btn btn-success btn-label right ms-auto nexttab nexttab"
                                                        data-nexttab="v-pills-gallery-tab"><i
                                                            class="ri-arrow-right-line label-icon align-middle fs-lg ms-2"></i>Go
                                                        to Gallery</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="v-pills-gallery" role="tabpanel"
                                                ...
                                                <div>
                                                    <div class="row gy-3">
                                                        <div class="col-md-6">
                                                            <label for="displayGallery" class="form-label">Display
                                                                Gallery:</label>
                                                            <input type="checkbox" name="displayGallery" value="1"
                                                                {{ old('displayGallery', $gallery->displayGallery ?? false) ? 'checked' : '' }}>
                                                        </div>

                                                        <div class="col-md-6">
                                                            <label for="gallery">Gallery:</label>
                                                            <textarea class="form-control @error('gallery') is-invalid @enderror" id="gallery" name="gallery" rows="3">{{ old('gallery', $gallery->gallery ?? '') }}</textarea>
                                                            @error('gallery')
                                                                <span class="text-danger"
                                                                    role="alert"><strong>{{ $message }}</strong></span>
                                                            @enderror
                                                ...
                                                <div class="d-flex align-items-start gap-3 mt-4">
                                                    <button type="button" class="btn btn-light btn-label previestab"
                                                        data-previous="v-pills-socialicons-tab">
                                                        <i
                                                            class="ri-arrow-left-line label-icon align-middle fs-lg me-2"></i>
                                                        Back to SocialIcons
                                                    </button>
