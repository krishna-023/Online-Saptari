...
@section('title', $item->title . ' - View Item')
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('item.edit', encrypt($item->id)) }}" class="btn btn-primary">
    ...
    <div class="row mb-4">
        <div class="col-xl-2 col-md-4 col-6">
            <div class="stat-card">
                ...
                <h4 class="mb-0">{{ $stats['total_gallery_images'] }}</h4>
        ...
        <div class="col-xl-2 col-md-4 col-6">
            <div class="stat-card" style="background: var(--success-gradient);">
                ...
                <h4 class="mb-0">{{ $stats['social_links_count'] }}</h4>
        ...
        <div class="col-xl-2 col-md-4 col-6">
            <div class="stat-card" style="background: var(--warning-gradient);">
                ...
                <h4 class="mb-0">{{ $stats['has_opening_hours'] ? 'Yes' : 'No' }}</h4>
        ...
        <div class="col-xl-2 col-md-4 col-6">
            <div class="stat-card" style="background: var(--info-gradient);">
                ...
                <h4 class="mb-0">{{ $stats['has_contact_info'] ? 'Yes' : 'No' }}</h4>
        ...
        <div class="col-xl-2 col-md-4 col-6">
            <div class="stat-card" style="background: var(--dark-gradient);">
                ...
                <h4 class="mb-0">{{ $stats['is_featured'] ? 'Yes' : 'No' }}</h4>
        ...
        <div class="col-xl-2 col-md-4 col-6">
            <div class="stat-card" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                ...
                <h4 class="mb-0">{{ $item->collection_date ? \Carbon\Carbon::parse($item->collection_date)->format('M j') : 'N/A' }}</h4>
    ...
    <div class="row g-4">
            ...
            <div class="glass-card p-4 h-100">
                ...
                <div class="mb-3">
                    <span class="info-chip">
                        <i class="ri-hashtag"></i> ID: {{ $item->id }}
                    </span>
                    <span class="info-chip">
                        <i class="ri-price-tag-3-line"></i> {{ $item->category->Category_Name ?? 'N/A' }}
                    </span>
                    <span class="badge badge-featured">
                        <i class="ri-star-line me-1"></i> {{ $item->item_featured ? 'Featured' : 'Not Featured' }}
                    </span>
                </div>
                ...
                <div class="row g-2">
                    <div class="col-12">
                        ...
                        <p class="mb-2 fw-semibold">
                            ...
                            {{ $item->collection_date ? \Carbon\Carbon::parse($item->collection_date)->format('F j, Y') : 'Not set' }}
                        </p>
                    </div>
                    <div class="col-6">
            ...
            <div class="glass-card p-4 h-100">
                ...
                <div class="mb-3">
                    ...
                    <div class="content-preview">
                        {!! nl2br(e($item->content ?? 'No content available')) !!}
                    </div>
                </div>
                ...
                <div class="row g-2">
                    <div class="col-md-6">
                        ...
                        <a href="mailto:{{ $item->author_email }}" class="text-decoration-none">
                            <i class="ri-mail-line me-1"></i>{{ $item->author_email }}
                        </a>
                    </div>
                    <div class="col-md-6">
                        ...
                        <p class="mb-0 fw-semibold">
                            <i class="ri-link me-1"></i>{{ $item->slug }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="glass-card p-4 h-100">
                ...
                <div class="row g-2 mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="contact-badge">
                            ...
                            <a href="tel:{{ $item->contacts->telephone }}" class="text-white text-decoration-none">
                    ...
                    <div class="col-md-6">
                        <div class="contact-badge" style="background: var(--info-gradient);">
                            ...
                            <a href="mailto:{{ $item->contacts->email }}" class="text-white text-decoration-none">
                                {{ $item->contacts->email }}
                            </a>
                        </div>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <p class="mb-1">
                        ...
                        <a href="tel:{{ $item->contacts->phone1 }}">{{ $item->contacts->phone1 }}</a>
                    </p>
                    @endif
                    ...
                    <p class="mb-1">
                        ...
                        <a href="tel:{{ $item->contacts->phone2 }}">{{ $item->contacts->phone2 }}</a>
                    </p>
                    @endif
                    ...
                    <p class="mb-0">
                        ...
                        <strong>Address:</strong> {{ $item->contacts->address }}
                    </p>
                    @endif
                </div>
                @else
            ...
            <div class="glass-card p-4 h-100">
                ...
                <div class="accordion" id="openingTimesAccordion">
                    ...
                    <div class="accordion-glass">
                        <div class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{ $loop->index }}">
                                <i class="ri-calendar-line me-2"></i>{{ $day }}
                            </button>
                        </div>
                        <div id="collapse{{ $loop->index }}" class="accordion-collapse collapse" data-bs-parent="#openingTimesAccordion">
                    ...
                    <div class="mt-3 p-3 bg-light rounded">
                        ...
                        <strong>Note:</strong> {{ $item->openingTimes->openingHoursNote }}
                    </div>
                    @endif
                </div>
                @else
        ...
        <div class="col-xl-6">
            <div class="glass-card p-4 h-100">
                ...
                @if($item->socialIcons && $item->socialIcons->count())
                <div class="d-flex flex-wrap">
                    @foreach($item->socialIcons as $socialIcon)
                    @if($socialIcon->socialIcons_url)
                    <a href="{{ $socialIcon->socialIcons_url }}"
                       class="social-link"
                       target="{{ $socialIcon->socialIconsOpenInNewWindow ? '_blank' : '_self' }}"
                       title="{{ ucfirst($socialIcon->socialIcons) }}">
                        <i class="ri-{{ strtolower($socialIcon->socialIcons) }}-line me-2"></i>
                        {{ ucfirst($socialIcon->socialIcons) }}
                    </a>
                    @endif
                    @endforeach
                </div>
        ...
        <div class="col-12">
            <div class="glass-card p-4">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <span class="badge bg-primary ms-2">{{ $stats['total_gallery_images'] }} images</span>
                </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    @if($item->contacts && is_numeric($item->contacts->latitude) && is_numeric($item->contacts->longitude))
        let marker = L.marker([{{ $item->contacts->latitude }}, {{ $item->contacts->longitude }}]).addTo(map);
        let popupContent = `
            <div class="p-2">
                <h6 class="mb-1">{{ $item->title }}</h6>
                <p class="mb-1 small">{{ $item->contacts->address ?? 'No address' }}</p>
                @if($item->contacts->telephone)
                <p class="mb-0 small">
                    <i class="ri-phone-line"></i>
                    <a href="tel:{{ $item->contacts->telephone }}">{{ $item->contacts->telephone }}</a>
                </p>
                @endif
            </div>
        `;
        marker.bindPopup(popupContent).openPopup();
        map.setView([{{ $item->contacts->latitude }}, {{ $item->contacts->longitude }}], 14);
    @endif
