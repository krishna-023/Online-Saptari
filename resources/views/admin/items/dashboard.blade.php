                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $item->title }}</td>
                            <td>
                                {{ $item->category ? ($item->category->parent ? $item->category->parent->Category_Name.' > ' : '') . $item->category->Category_Name : 'N/A' }}
                            </td>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const itemsChart = new ApexCharts(document.querySelector("#itemsChart"), {
        ...
        series: [{{ $itemsAdded ?? 0 }}, {{ $itemsModified ?? 0 }}],
    ...
    // -------------------
    let categoriesData = @json($categoriesChartData);
