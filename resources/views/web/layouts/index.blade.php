                            ...
                            <div class="card shadow-none border-bottom rounded-0 mb-0">
                                <div class="card-body">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <h4 class="fw-semibold mb-3"><span class="counter-value" data-target="684">0</span>
                                        </h4>
                                        <div class="d-flex align-items-center gap-2">
                                            <h5 class="text-success fs-xs mb-0">
                        ...
                        <div class="card-body border-start-xl border-top border-top-xl-0 border-2 h-100">
                            ...
                            <div class="mt-4">
                                ...
                                <h4>$7,45,123 <small class="text-danger fs-sm fw-normal"><i
                                            class="ph-arrow-down align-baseline"></i> -1.36%</small></h4>
                            ...
                            <div class="mt-4">
                                <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal"
                                    data-bs-target="#addAmount">Add Amount</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div id="world-map-line-markers" data-colors='["--tb-light"]' dir="ltr"
                            ...
                            <div>
                                <ul class="list-unstyled vstack gap-2">
                                    <li class="p-2 rounded">
                                        <i class="ri-checkbox-blank-circle-fill text-primary align-bottom me-1"></i> United
                                        States <span class="float-end">15,364</span>
                                    </li>
                                    ...
                                    <li class="bg-light-subtle p-2 rounded">
                                        <i class="ri-checkbox-blank-circle-fill text-success align-bottom me-1"></i> Russia
                                        <span class="float-end">7,108</span>
                                    </li>
                                    <li class="p-2 rounded">
                                        <i class="ri-checkbox-blank-circle-fill text-danger align-bottom me-1"></i> Brazil
                                        <span class="float-end">6,731</span>
                                    </li>
                                    <li class="bg-light-subtle p-2 rounded">
                                        <i class="ri-checkbox-blank-circle-fill text-warning align-bottom me-1"></i> Sydney
                                        <span class="float-end">3,023</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-1">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('build/images/users/48/avatar-2.jpg') }}" alt=""
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-1">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('build/images/users/48/avatar-7.jpg') }}" alt=""
                                                    class="avatar-sm rounded-circle p-1">
                                            </div>
                                            <div class="flex-grow-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-1">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('build/images/users/48/avatar-4.jpg') }}" alt=""
                                                    class="avatar-sm rounded-circle p-1">
                                            </div>
                                            <div class="flex-grow-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-1">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('build/images/users/48/avatar-5.jpg') }}" alt=""
                                                    class="avatar-sm rounded-circle p-1">
                                            </div>
                                            <div class="flex-grow-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-1">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('build/images/users/48/avatar-6.jpg') }}" alt=""
                                                    class="avatar-sm rounded-circle p-1">
                                            </div>
                                            <div class="flex-grow-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-1">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('build/images/users/48/avatar-1.jpg') }}" alt=""
                                                    class="avatar-sm rounded-circle p-1">
                                            </div>
                                            <div class="flex-grow-1">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-1">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('build/images/users/48/avatar-8.jpg') }}" alt=""
                                                    class="avatar-sm rounded-circle p-1">
                                            </div>
                                            <div class="flex-grow-1">
                        ...
                        <div class="vstack gap-2">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <div class="avatar-sm flex-shrink-0">
                                        <div class="avatar-title bg-light rounded">
                                            <img src="{{ URL::asset('build/images/products/32/img-1.png') }}" alt=""
                                                class="avatar-xs">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <div class="p-2 border border-dashed">
                                <div class="d-flex align-items-center gap-2">
                                    <div class="avatar-sm flex-shrink-0">
                                        <div class="avatar-title bg-light rounded">
                                            <img src="{{ URL::asset('build/images/products/32/img-2.png') }}" alt=""
                                                class="avatar-xs">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <div class="p-2 border border-dashed">
                                <div class="d-flex align-items-center gap-2">
                                    <div class="avatar-sm flex-shrink-0">
                                        <div class="avatar-title bg-light rounded">
                                            <img src="{{ URL::asset('build/images/products/32/img-3.png') }}" alt=""
                                                class="avatar-xs">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <div class="p-2 border border-dashed">
                                <div class="d-flex align-items-center gap-2">
                                    <div class="avatar-sm flex-shrink-0">
                                        <div class="avatar-title bg-light rounded">
                                            <img src="{{ URL::asset('build/images/products/32/img-4.png') }}" alt=""
                                                class="avatar-xs">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <div class="p-2 border border-dashed">
                                <div class="d-flex align-items-center gap-2">
                                    <div class="avatar-sm flex-shrink-0">
                                        <div class="avatar-title bg-light rounded">
                                            <img src="{{ URL::asset('build/images/products/32/img-5.png') }}" alt=""
                                                class="avatar-xs">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <div class="p-2 border border-dashed">
                                <div class="d-flex align-items-center gap-2">
                                    <div class="avatar-sm flex-shrink-0">
                                        <div class="avatar-title bg-light rounded">
                                            <img src="{{ URL::asset('build/images/products/32/img-6.png') }}" alt=""
                                                class="avatar-xs">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                    ...
                    <div data-simplebar class="px-3" style="max-height: 258px;">
                        <div class="acitivity-timeline acitivity-main">
                            ...
                            <div class="acitivity-item py-3 d-flex">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('build/images/users/32/avatar-2.jpg') }}" alt=""
                    ...
                    <div class="row g-0">
                        <div class="col-lg-5">
                            <div class="bg-primary-subtle p-5 h-100">
                                <div class="p-lg-4">
                                    <img src="{{ URL::asset('build/images/products/32/img-3.png') }}" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <!--end col-->
