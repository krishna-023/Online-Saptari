    ...
    <div class="row g-4">
      ...
      <div class="col-lg-2 col-md-6">
        ...
        <ul class="list-unstyled small">
          ...
          <li class="mb-2">
            <a href="{{ route('item.index') }}" class="text-light text-decoration-none">
      ...
      <div class="col-lg-2 col-md-6">
        ...
        <ul class="list-unstyled small">
          @auth
            ...
            <li class="mb-2">
              <a href="{{ route('item.profile') }}" class="text-light text-decoration-none">
                <i class="fas fa-chevron-right me-2"></i>My Profile
              </a>
            </li>
            <li class="mb-2">
              <a href="{{ route('item.add') }}" class="text-light text-decoration-none">
