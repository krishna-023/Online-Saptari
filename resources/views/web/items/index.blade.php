...
@section('content')
  ...
  <div class="search_container_block home_main_search_part main_search_block" data-background-image="{{ asset('web/images/search_slider_bg_1.jpg') }}" data-color="#000" data-color-opacity="0.85" data-img-width="2500" data-img-height="1666">
  ...
  <div class="container padding-bottom-70">
    <div class="row">
      ...
      <div class="col-md-4 col-sm-6 col-xs-12">
         <a href="listings_list_with_sidebar.html" class="img-box" data-background-image="{{ asset('web/images/search_slider_bg_1.jpg') }}" data-color="#000" data-color-opacity="0.85" data-img-width="2500" data-img-height="1666-01.jpg">
      ...
      <div class="col-md-4 col-sm-6 col-xs-12">
         <a href="listings_list_with_sidebar.html" class="img-box" data-background-image="{{ asset('web/images/search_slider_bg_1.jpg') }}" data-color="#000" data-color-opacity="0.85" data-img-width="2500" data-img-height="1666-02.jpg">
			<div class="utf_img_content_box visible">
			  <h4>Shops</h4>
      ...
      <div class="col-md-4 col-sm-6 col-xs-12">
         <a href="listings_list_with_sidebar.html" class="img-box" data-background-image="{{ asset('web/images/search_slider_bg_1.jpg') }}" data-color="#000" data-color-opacity="0.85" data-img-width="2500" data-img-height="1666-03.jpg">
			<div class="utf_img_content_box visible">
			  <h4>Restaurant</h4>
      ...
      <div class="col-md-4 col-sm-6 col-xs-12">
         <a href="listings_list_with_sidebar.html" class="img-box" data-background-image="{{ asset('web/images/search_slider_bg_1.jpg') }}" data-color="#000" data-color-opacity="0.85" data-img-width="2500" data-img-height="1666-04.jpg">
			<div class="utf_img_content_box visible">
      ...
      <div class="col-md-4 col-sm-6 col-xs-12">
         <a href="listings_list_with_sidebar.html" class="img-box" data-background-image="{{ asset('web/images/search_slider_bg_1.jpg') }}" data-color="#000" data-color-opacity="0.85" data-img-width="2500" data-img-height="1666-05.jpg">
			<div class="utf_img_content_box visible">
			  <h4>Hotels</h4>
      ...
      <div class="col-md-4 col-sm-6 col-xs-12">
         <a href="listings_list_with_sidebar.html" class="img-box" data-background-image="{{ asset('web/images/search_slider_bg_1.jpg') }}" data-color="#000" data-color-opacity="0.85" data-img-width="2500" data-img-height="1666-06.jpg">
			<div class="utf_img_content_box visible">
			  <h4>New York</h4>
			...
			<div class="col-md-12">
				<div class="simple_slick_carousel_block utf_dots_nav">
				  <div class="utf_carousel_item"> <a href="listings_single_page_1.html" class="utf_listing_item-container compact">
					<div class="utf_listing_item"> <img src="{{asset('web/images/utf_listing_item-01.jpg')}}" alt=""> <span class="tag"><i class="im im-icon-Chef-Hat"></i> Restaurant</span> <span class="featured_tag">Featured</span>
				  ...
				  <div class="utf_carousel_item"> <a href="listings_single_page_1.html" class="utf_listing_item-container compact">
					<div class="utf_listing_item"> <img src="{{asset('web/images/utf_listing_item-02.jpg')}}" alt=""> <span class="tag"><i class="im im-icon-Electric-Guitar"></i> Events</span>
					  <div class="utf_listing_item_content">
					    <div class="utf_listing_prige_block">
				  ...
				  <div class="utf_carousel_item"> <a href="listings_single_page_1.html" class="utf_listing_item-container compact">
					<div class="utf_listing_item"> <img src="{{asset('web/images/utf_listing_item-03.jpg')}}" alt=""> <span class="tag"><i class="im im-icon-Hotel"></i> Hotels</span>
				  ...
				  <div class="utf_carousel_item"> <a href="listings_single_page_1.html" class="utf_listing_item-container compact">
					<div class="utf_listing_item"> <img src="{{asset('web/images/utf_listing_item-04.jpg')}}" alt=""> <span class="tag"><i class="im im-icon-Dumbbell"></i> Fitness</span>
					  <div class="utf_listing_item_content">
					    <div class="utf_listing_prige_block">
							<span class="utf_meta_listing_price"><i class="fa fa-tag"></i> $45 - $70</span>
							<span class="utp_approve_item"><i class="utf_approve_listing"></i></span>
				  ...
				  <div class="utf_carousel_item"> <a href="listings_single_page_1.html" class="utf_listing_item-container compact">
					<div class="utf_listing_item"> <img src="{{asset('web/images/utf_listing_item-05.jpg')}}" alt=""> <span class="tag"><i class="im im-icon-Hotel"></i> Hotels</span> <span class="featured_tag">Featured</span>
					  <span class="utf_closed">Closed</span>
					  <div class="utf_listing_item_content">
					    <div class="utf_listing_prige_block">
							<span class="utf_meta_listing_price"><i class="fa fa-tag"></i> $45 - $70</span>
				  ...
				  <div class="utf_carousel_item"> <a href="listings_single_page_1.html" class="utf_listing_item-container compact">
					<div class="utf_listing_item"> <img src="{{asset('web/images/utf_listing_item-06.jpg')}}" alt=""> <span class="tag"><i class="im im-icon-Chef-Hat"></i> Restaurant</span>
					  <span class="utf_open_now">Open Now</span>
					  <div class="utf_listing_item_content">
					    <div class="utf_listing_prige_block">
  ...
  <a href="listings_grid_full_width.html" class="flip-banner parallax" data-background="{{ asset('web/images/slider-bg-02.jpg') }}" data-color="#000" data-color-opacity="0.85" data-img-width="2500" data-img-height="1666">
    ...
    <div class="fullwidth_carousel_container_block margin-top-20">
      <div class="utf_testimonial_carousel testimonials">
        <div class="utf_carousel_review_part">
          ...
          <div class="utf_testimonial_author"> <img src="{{asset('web/images/happy-client-01')}}.jpg" alt="">
        ...
        <div class="utf_carousel_review_part">
          ...
          <div class="utf_testimonial_author"> <img src="{{asset('web/images/happy-client-02')}}.jpg" alt="">
        ...
        <div class="utf_carousel_review_part">
          ...
          <div class="utf_testimonial_author"> <img src="{{asset('web/images/happy-client-03')}}.jpg" alt="">
  ...
  <section class="fullwidth_block padding-top-75 padding-bottom-75" data-background-color="#ffffff">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12"> <a href="blog_detail_left_sidebar.html" class="blog_compact_part-container">
          <div class="blog_compact_part"> <img src="{{asset('web/images/blog-compact-post')}}-01.jpg" alt="">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12"> <a href="blog_detail_left_sidebar.html" class="blog_compact_part-container">
          <div class="blog_compact_part"> <img src="{{asset('web/images/blog-compact-post')}}-02.jpg" alt="">
            <div class="blog_compact_part_content">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12"> <a href="blog_detail_left_sidebar.html" class="blog_compact_part-container">
          <div class="blog_compact_part"> <img src="{{asset('web/images/blog-compact-post')}}-03.jpg" alt="">
            <div class="blog_compact_part_content">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12"> <a href="blog_detail_left_sidebar.html" class="blog_compact_part-container">
          <div class="blog_compact_part"> <img src="{{asset('web/images/blog-compact-post')}}-04.jpg" alt="">
            <div class="blog_compact_part_content">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="companie-logo-slick-carousel utf_dots_nav">
					<div class="item">
						<img src="{{asset('web/images/brand_logo_01.png')}}" alt="">
					</div>
					<div class="item">
						<img src="{{asset('web/images/brand_logo_02.png')}}" alt="">
					</div>
					<div class="item">
						<img src="{{asset('web/images/brand_logo_03.png')}}" alt="">
					</div>
					<div class="item">
						<img src="{{asset('web/images/brand_logo_04.png')}}" alt="">
					</div>
					<div class="item">
						<img src="{{asset('web/images/brand_logo_05.png')}}" alt="">
					</div>
					<div class="item">
						<img src="{{asset('web/images/brand_logo_06.png')}}" alt="">
					</div>
					<div class="item">
						<img src="{{asset('web/images/brand_logo_07.png')}}" alt="">
					</div>
				</div>
			</div>
		</div>
